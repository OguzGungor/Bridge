...
import { addFavBook, addReadBook, applyJob, getAppliedJobs, getHiredJobs } from "../../../util/employee/Jobs";
import { getBooks, getJobs } from "../../../util/common/common";

class HiredJobs extends React.Component {
...
export default withRouter(HiredJobs);